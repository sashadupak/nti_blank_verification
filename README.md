...
На данный момент код работает только со старой версией библиобтеки opencv, см. *requirements.txt*.
Также есть еще несколько других нюансов, все в процессе исправления.
