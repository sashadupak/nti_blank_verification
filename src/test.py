...
def MatchFeatures(img1, img2):
    ...
    f=cv2.drawKeypoints(img1,kp1,None,[0,0,255],flags=cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
    nf=cv2.drawKeypoints(img2,kp2,None,[255,0,0],flags=cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
