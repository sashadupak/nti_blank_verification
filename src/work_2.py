...
def main():
    ...
    writer.writerow(["File name", "number of matches", "correct blank", "area of sign", "confirmed"])

    # main variables
    def_h = 750 # image resolution (y axis) - dependent (TODO independent)
    min_match = 50 # min number of matches, correct = 70-364, wrong = 0-33
    min_sign_area = [500, 750, 500] # min area of sign, correct = 599-899/1057-1142/?, wrong = 0-392/0-491/?
    ...
    sp = [[650, 690, 350, 400], [615, 645, 135, 185], [620, 660, 400, 440]]  
    ...
    for j in range(len(file_names)):
        ...
        for i in range(len(ref)):
            ...
            if ok:
                ...
                break
        writer.writerow([file_names[j].split("\\")[1], str(len(good)), str(int(ok)), str(sign_area), str(int(confirmed))])
